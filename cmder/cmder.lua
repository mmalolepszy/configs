function set_custom_prompt_filter()
    ...
    local cmder_prompt = "\x1b[1;32;40m{cwd} {git_enhanced} \x1b[1;30;40m{lamb} \x1b[0m"
...
clink.prompt.register_filter(set_custom_prompt_filter, 1)
